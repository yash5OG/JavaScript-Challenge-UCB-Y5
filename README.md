...
UFO 1 and UFO 2 folders are created. 
Same template was used for both.

UFO 1 filters for date from data.js

and 
UFO2 filters from Date, City, State, Country, Shape

Index.html was tweaked for colors.



Below are assignment instructions.
